...
if ($_POST) {
    ...
    if ($thisclient) {
        ...
        if(!$_POST['captcha'])
            $errors['captcha']='Entrez le texte de l\'image';
        elseif(strcmp($_SESSION['captcha'], md5(strtoupper($_POST['captcha']))))
            $errors['captcha']='Invalide - Essayez encore !';
    }
    ...
    if(($ticket=Ticket::create($vars, $errors, SOURCE))){
        $msg='Demande de ticket de support créée';
        ...
        $errors['err']=$errors['err']?$errors['err']:'Impossible de créer un ticket. Veuillez corriger les erreurs ci-dessous et réessayer !';
    }
}
