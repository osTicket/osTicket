...
define('SECRET_SALT','J01Ve7W4slfcebDHjcnzVJZt09DTiJXf');

#Default admin email. Used only on db connection issues and related alerts.
define('ADMIN_EMAIL','oaeaoeaoeaoeaoe@vblip.com');
...
define('DBNAME','ost-dev-form-installer');
define('DBUSER','ostdev');
define('DBPASS','ostdev');
