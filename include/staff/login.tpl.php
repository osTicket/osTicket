...
?>
<div id="loginBox">
    <h1 id="logo"><a href="index.php"><?php t("osTicket Staff Control Panel"); ?></a></h1>
    <h3><?php echo Format::htmlchars(st($msg)); ?></h3>
    <form action="login.php" method="post">
        ...
        <h3 style="display:inline"><a href="pwreset.php"><?php t("Forgot my password"); ?></a></h3>
        <?php } ?>
        <input class="submit" type="submit" name="submit" value="<?php t("Log In"); ?>">
    </form>
</div>
