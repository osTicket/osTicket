...
<div style="display:none;" class="dialog" id="confirm-action">
    ...
    <p class="confirm-action" style="display:none;" id="enable-confirm">
        <?php echo __('Are you sure want to <b>enable</b> selected pages?'); ?>
    </p>
    <p class="confirm-action" style="display:none;" id="disable-confirm">
        <?php echo __('Are you sure want to <b>disable</b> selected pages?'); ?>
    </p>
    <p class="confirm-action" style="display:none;" id="delete-confirm">
        <font color="red"><strong><?php echo __(
        'Are you sure you want to DELETE selected pages?'); ?></strong></font>
        <br><br><?php echo __('Deleted pages CANNOT be recovered.'); ?>
    </p>
