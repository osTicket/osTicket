        ...
        <div class="login-box">
            ...
            <div>
                <label for="email"><?= __('E-Mail Address'); ?>:
                    <input id="email" placeholder="<?= __('e.g. john.doe@osticket.com'); ?>" type="text" name="lemail" size="30" value="<?= $email; ?>"></label>
            </div>
            <div>
                <label for="ticketno"><?= __('Ticket Number'); ?>:
                    <input id="ticketno" type="text" name="lticket" placeholder="<?= __('e.g. 051243'); ?>" size="30" value="<?= $ticketid; ?>"></label>
            </div>
            <p><input class="btn" type="submit" value="<?= $button; ?>"></p>
        </div>
        <div class="instructions">
            <?php if ($cfg && $cfg->getClientRegistrationMode() !== 'disabled') : ?>
                <?= __('Have an account with us?'); ?>
                <a href="login.php"><?= __('Sign In'); ?></a> <?php if ($cfg->isClientRegistrationEnabled()) : ?>
                    <?php
...
<br>
<p>
    <?= sprintf(__("If this is your first time contacting us or you've lost the ticket number, please %s open a new ticket %s"), '<a href="open.php">', '</a>'); ?>
</p>
