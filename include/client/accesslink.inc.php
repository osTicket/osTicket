...
<h1><?php echo __('Check Ticket Status'); ?></h1></div>
...
<form action="login.php" method="post" id="clientLogin">
	...
	<div class="row ">
   	<div class="col-sm">
   		...
   		<p >
        		<input class="btn btn-outline-primary" type="submit" value="<?php echo $button; ?>">
    		</p>
    	</div>
    	<div class="col-sm" style="padding-right: 1rem; padding-top: 2rem;">
