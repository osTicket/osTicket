...
<head>
    ...
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor.unpacked.js?1"></script>
    <script type="text/javascript" src="<?php echo ROOT_PATH; ?>js/redactor-plugins.js?1"></script>
