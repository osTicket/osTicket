...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css" media="screen">
    <link type="text/css" rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/theme.css" media="screen">
    <link type="text/css" rel="stylesheet" href="<?php echo ASSETS_PATH; ?>css/print.css" media="print">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/typeahead.css" media="screen" />
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/ui-lightness/jquery-ui-1.10.3.custom.min.css" media="screen" />
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/thread.css" media="screen">
    <link type="text/css" rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/redactor.css" media="screen">
