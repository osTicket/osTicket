...
<form id="ticketForm" method="post" action="open.php" enctype="multipart/form-data" class="form-horizontal">
  ...
  <div class="form-group">
    <label for="topicId" class="col-sm-2 control-label required"><?php echo __('Help Topic');?>:</label>
    <div class="col-sm-10">
  ...
  if (!$thisclient) {
    ...
    <div class="form-group">
      ...
      <div class="col-sm-10">
        <p class="form-control-static"><?php echo $thisclient->getEmail(); ?></p>
      </div>
    </div>
    <div class="form-group">
      <label class="col-sm-2 control-label"><?php echo __('Client'); ?>:</label>
      <div class="col-sm-10">
        <p class="form-control-static"><?php echo $thisclient->getName(); ?></p>
      </div>
    </div>
  <?php } ?>
  ...
  if($cfg && $cfg->isCaptchaEnabled() && (!$thisclient || !$thisclient->isValid())) {
    ...
    ?>
    <div class="form-group">
      <label class="col-sm-2 control-label required"><?php echo __('CAPTCHA Text');?>:</label>
      <div class="col-sm-10">
