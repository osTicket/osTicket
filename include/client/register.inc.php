...
<div class="p-3">
		...
		<div class="col-md align-self-center">
      <input type="submit" class="btn btn-outline-primary" value="<?php echo __('Register'); ?>"/>
		</div>
	
		<div class="col-md align-self-center" style="padding-bottom: 1rem;">    
    		<input type="button" class="btn btn-outline-danger" value="<?php echo __('Cancel'); ?>" onclick="javascript:
